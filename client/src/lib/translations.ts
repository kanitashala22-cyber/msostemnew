...
export const translations = {
  ...
  sq: {
    ...
    about: {
      ...
      founderTitle: "Njihni Themeluesin",
      founderName: "Kanita Shala",
      founderRole: "Themeluesja & Aktiviste e Rinjës",
      founderBio: "Kanita Shala është një aktiviste e rinjës apasionante e dedikuar për të thyer barrierat në edukimin e teknologjisë. Si themeluesja e MsoSTEM, ajo drejton misionin për të krijuar mundësi të barabarta për grua të reja në fushën e STEM.",
      ...
      missionText: "Të krijoni një komunitet mbështetës dhe përfshirës ku grua të reja mund të mësojnë të kodojnë, të ndërtojnë projekte dhe të qasjen bursa që u ndihmojnë të ndjekjin karriera të suksesshme në teknologji.",
      ...
      existText: "Industria e teknologjisë përballet me një hendek të rëndësishëm gjinie. Gratë nënpërfaqësohen në rolet e kodimit dhe inxhinierisë. MsoSTEM u krijua për të mbushur këtë hendek duke ofruar edukimin e aksesueshëm dhe fillestar të kodimit dhe duke lidhur grua të reja me mundësi bursash.",
      whatWeDo: "Çfarë Bëjmë Ne",
      feature1: "Ofroni Kurse Kodimi Interaktiv",
      feature1Desc: "Mësimet praktike HTML dhe CSS të dizajnuara posaçërisht për fillestarët pa përvojë kodimi.",
      feature2: "Ofrojmë Bursa Reale",
      ...
      feature4: "Freskojmë Liderë të Ardhshëm në Tech",
      feature4Desc: "Fuqizoni gratë për të ndjekur karriera në teknologji dhe të bëhen brezin tjetër i inovatorëve.",
