  ...
  en: {
    ...
    home: {
      ...
      courses: {
        ...
        pathSubtitle:
          "Follow our structured path to become confident in web development",
    ...
    scholarshipContent: {
      ...
      "scholarship-6": {
        ...
        aboutProgram: {
          ...
          description:
            "UWC is a global movement of 18 selective international schools in countries across five continents, serving over 3,500 students from more than 180 countries and territories. Founded in 1962, UWC makes education a force to unite people, nations and cultures for peace and a sustainable future. Each UWC offers the International Baccalaureate (IB) Diploma Program combined with a distinctive educational philosophy emphasizing international cooperation, environmental sustainability, and the development of responsible global citizens. UWC students live, study, and work together in a multicultural community, learning to understand and appreciate diverse perspectives while developing solutions to global challenges. The movement believes that a good education can create leaders committed to building a more peaceful and sustainable world.",
          programHighlights: {
            title: "Program Highlights",
            items: [
              "Two-year International Baccalaureate (IB) Diploma program on international campus",
              "Education based on four pillars: academic excellence, artistic expression, athletic development, and service to community",
              "Live on campus with 3,500+ students from 180+ countries and territories",
              "Prestigious International Baccalaureate (IB) Curriculum recognized worldwide",
              "Focus on environmental sustainability, global citizenship, and responsible leadership",
              "Access to UWC's global alumni network of 50,000+ professionals worldwide",
            ],
          },
          programComponents: {
            title: "Program Components",
            items: [
              "Rigorous academic curriculum with International Baccalaureate (IB) examinations",
              "Creativity, Activity, Service (CAS) program integrating arts, sports, and community engagement",
              "Environmental initiatives and sustainability projects addressing climate change",
              "Global citizenship education and intercultural dialogue workshops",
              "Leadership development through student government and peer mentorship",
              "Experiential learning with field trips, research projects, and global partnerships",
            ],
          },
        },
        eligibilityRequirements: {
          ...
          basicRequirements: {
            ...
            items: [
              "Ages 16-19 at time of application (program is 2 years: IB Year 1 and Year 2)",
              "Citizens of any country or long-term residents of any UWC country",
              "Strong academic achievement in previous schooling (typically top 10-15% of cohort)",
              "Demonstrated leadership potential and extracurricular involvement",
              "Fluency in English (language of instruction at UWCs)",
              "Commitment to UWC principles of international cooperation and service",
            ],
          },
          applicationRequirements: {
            title: "Application Requirements",
            items: [
              "Complete online application through national UWC committee",
              "Latest academic transcripts and grades",
              "Personal essays addressing UWC mission and your fit",
              "2-3 academic and character recommendation letters from school",
              "Evidence of leadership and community involvement (portfolio, resume)",
              "Interview conducted by national selection committee",
              "Some countries require entrance examinations",
            ],
          },
          selectionCriteria: {
            ...
            items: [
              ...
              "Demonstrated leadership qualities and potential for growth",
              "Commitment to community service and social responsibility",
              "Cross-cultural awareness and ability to thrive in diverse environment",
              "Vision for future contributions to global community",
              "Personal integrity and commitment to UWC values",
              "Communication skills and collaborative spirit",
            ],
          },
        },
        applicationTimeline: {
          ...
          timeline: {
            ...
            items: [
              "Registration opens: May - June (contact your national UWC committee)",
              "Application submissions: September - November (varies by country)",
              "National interviews: December - January",
              "Final results announced: March - April",
              "Accepted students confirm enrollment: May",
          ...
          requirements: {
            title: "How to Apply",
            items: [
              "Visit uwc.org to find your national UWC committee",
              "Register and complete the online application form",
              "Submit academic transcripts, essays, and recommendations",
              "Prepare for interview with national selection committee",
              "If selected nationally, interview may advance to UWC schools",
              "Receive official admission decision and acceptance package",
            ],
          },
          selectionProcess: {
            title: "Selection Process",
            items: [
              "Screening of applications by national UWC committee",
              "Interview conducted by national committee members",
              "Evaluation of leadership potential and UWC fit",
              "Shortlisted candidates may interview with UWC schools",
              "Final recommendations and admission decisions",
              "Notification and enrollment confirmation by accepted students",
            ],
          },
        },
        badgeText: {
          open: "Open for Applications",
          upcoming: "Applications Opening Soon",
  ...
  sq: {
    ...
    home: {
      hero: {
        ...
        subtitle:
          "Bashkohu me mijëra gra të reja që mësojnë të kodojnë me HTML & CSS, dhe zbulo bursa që mund të transformojnë të ardhmen tënde në teknologji.",
      ...
      cta: {
        ...
        subtitle:
          "Ndërto të ardhmen tënde në teknologji me kurset tona miqësore për fillestarë dhe zbulo bursa që mund të financojnë ëndrrat e tua.",
      ...
      courses: {
        ...
        subtitle:
          "Mëso HTML dhe CSS përmes projekteve praktike dhe mësimeve interaktive të dizajnuara posaçërisht për fillestarë.",
        pathTitle: "Udhëtimi Yt i Të Mësuarit Fillon Këtu",
        pathSubtitle:
          "Ndiq rrugën tonë të strukturuar për të bërë të vetëbesuar në zhvillimin e uebit",
        ...
        playgroundDesc:
          "Praktiko aftësitë në editorin tonë të drejtpërdrejtë me pamje paraprake të menjëhershme. Shiko ndryshimet në kohë reale!",
      ...
      footer: {
        about: "Rreth MsoSTEM",
        aboutText:
          "Fuqizimi i grave për të koduar, krijimi i rrugëve drejt suksesit dhe ndërtimi i një industrie teknologjike më gjithëpërfshirëse, një studente në një kohë.",
    ...
    scholarship: {
      ...
      amount: "Shuma e Çmimit",
      description:
        "Zbuloni mundësi financimi që mund të ju ndihmojnë të ndiqni ëndrrat tuaja në teknologji dhe shkenca kompjuterike.",
    },
    // Playground
    playground: {
      ...
      description:
        "Eksperimento me HTML dhe CSS në editorin tonë interaktiv. Shiko ndryshimet të vijnë në jetë menjëherë!",
    ...
    courseContent: {
      "course-1": {
        title: "Bazat e HTML",
        description:
          "Zotëro blloqet ndërtuese të uebit me mësime gjithëpërfshirëse dhe miqësore për fillestarë të HTML dhe projekte interaktive praktike. Mëso gjithçka nga etiketat bazë deri te veçoritë e avancuara HTML5!",
      },
      "course-2": {
        title: "Stilizimi dhe Dizajni me CSS",
        description:
          "Zotëro artin e dizajnit të bukur të uebit! Mëso CSS nga bazat deri te teknikat e avancuara përfshirë animacionet, strukturat dhe parimet moderne të dizajnit që bëjnë faqet e internetit të mahnitshme dhe profesionale.",
      },
      "course-3": {
        title: "Kiti Fillestar i Mikroprocesuesve Arduino",
        description:
          "Mëso të programosh mikroprocesuesit Arduino nga e para! Ndërto projekte emocionuese me shembuj kodi të lehtë për tu ndjekur, diagrame lidhëse dhe vizuale interaktive.",
      },
    },
    // Scholarship Content
    scholarshipContent: {
      "scholarship-1": {
        title: "TechGirls",
        description:
          "Program plotësisht i financuar nga Departamenti Amerikan i Shtetit që fuqizon gratë e reja (mosha 15-17) të ndjekin karriera STEM përmes një programi intensiv veror të shkëmbimit në Shtetet e Bashkuara.",
        ...
        eligibilityRequirements: {
          ...
          eligibleCountries: {
            ...
            regions: {
              subSaharanAfrica:
                "Afrika Subsahariane: Kamerun, Kenia, Nigjeria, Ruanda, Afrika e Jugut, Zambia",
              eastAsiaPacific:
                "Azia Lindore & Paqësori: Kamboxhia, Fixhi, Indonezia, Mongolia, Tajvan, Vietnami",
              europeEurasia:
                "Evropa & Eurazia: Shqipëria, Qipro, Greqia, Kosova, Mali i Zi, Turqia",
              middleEastNorthAfrica:
                "Lindja e Mesme & Afrika e Veriut: Algjeria, Egjipti, Jordania, Libani, Maroku, Territoret Palestineze, Tunizia",
              southCentralAsia:
                "Azia e Jugut & Qendrore: Kazakistani, Kirgizistani, Pakistani, Taxhikistani, Turkmenistani, Uzbekistani",
              westernHemisphere:
                "Hemisfera Perëndimore: Brazili, Kosta Rika, Ekuadori, Panama, Peruja, Surinami",
              unitedStates:
                "Shtetet e Bashkuara: Qytetarët dhe rezidentët amerikanë janë gjithashtu të pranueshëm",
            },
          },
        },
        programStructure: {
          ...
          phase1: {
            ...
            description:
              "Kamp teknologjik intensiv që ofron trajnim praktik STEM, vizita në laboratorë, ndjekje të punës me profesionistë teknologjikë dhe punëtori udhëheqjeje.",
          },
          phase2: {
            title: "Faza 2: Zhytje Komunitare",
            description:
              "Zhytje kulturore në qytete amerikane përfshirë Austin, Cincinnati, Denver, Detroit, Kansas City ose Seattle. Përjetoni jetën me familje pritëse dhe vizitoni kompani të mëdha teknologjike.",
          },
          phase3: {
            title: "Faza 3: Projekti i Veprimit Komunitar",
            description:
              "Kur të ktheheni në shtëpi, zbatoni një projekt STEM bazuar në komunitet si fillimi i klubeve teknologjike, mësimi i kodimit ose organizimi i panairit të karrierave.",
          },
        },
        applicationInfo: {
      ...
      "scholarship-2": {
        ...
        description:
          "Program shkëmbimi intensiv 4-javor plotësisht i financuar në Universitetin Purdue që fuqizon të rinjtë evropianë (mosha 16-18) të eksplorojnë diplomacinë, udhëheqjen dhe marrëdhëniet transatlantike në Shtetet e Bashkuara.",
        field:
          "Diplomaci, Udhëheqje, Marrëdhënie Ndërkombëtare, Shoqëria Civile",
        location: "Universiteti Purdue, West Lafayette, Indiana",
        eligibility:
          "Qytetarë evropianë mosha 16-18 me arritje të forta akademike dhe potencial udhëheqës",
        organizationName: "Departamenti Amerikan i Shtetit",
        aboutProgram: {
          title: "Rreth Bursës Benjamin Franklin Transatlantike",
          description:
            "Benjamin Franklin Transatlantic Fellowship (BFTF) është një program prestigjioz 4-javor i shkëmbimit veror i organizuar nga Universiteti Purdue që bashkon liderët e rinj evropianë për të eksploruar diplomacinë, udhëheqjen dhe marrëdhëniet transatlantike në Shtetet e Bashkuara. Ky program i financuar plotësisht i Departamentit të Shtetit të SHBA-së i fuqizon pjesëmarrësit të bëhen ambasadorë të ardhshëm të bashkëpunimit ndërkombëtar.",
          programHighlights: {
            title: "Pikat Kryesore të Programit",
            items: [
        ...
        eligibilityRequirements: {
          ...
          eligibleCountries: {
            ...
            regions: {
              europe:
                "Vende evropiane përfshirë: Shqipëria, Austria, Belgjika, Qipro, Republika Çeke, Estonia, Finlanda, Franca, Gjermania, Greqia, Hungaria, Irlanda, Italia, Kosova, Letonia, Lituania, Luksemburgu, Malta, Holanda, Polonia, Portugalia, Sllovakia, Sllovenia, Spanja dhe të tjerë.",
            },
          },
        },
        applicationInfo: {
      ...
      "scholarship-3": {
        ...
        description:
          "Program bursash konkurrues bazuar në merita që sjell studentë të shkollës së mesme nga vende me popullsi të konsiderueshme myslimane për të studiuar për një vit të plotë akademik në Shtetet e Bashkuara, duke jetuar me familje pritëse.",
        field: "Shkëmbim Kulturor, Udhëheqje",
        location: "Shkolla të Mesme në të gjitha Shtetet e Bashkuara",
        eligibility:
          "Studentë të shkollës së mesme (mosha 15-17) nga vende të caktuara me rekorde të forta akademike",
        organizationName: "Departamenti Amerikan i Shtetit",
        aboutProgram: {
          title: "Rreth Programit Kennedy-Lugar Youth Exchange & Study (YES)",
          description:
            "Programi Kennedy-Lugar Youth Exchange & Study (YES) është një program bursash konkurrues bazuar në merita, i financuar nga Departamenti Amerikan i Shtetit, që sjell studentë të shkollës së mesme nga vende me popullsi të konsiderueshme myslimane në Shtetet e Bashkuara për një vit të plotë akademik. Studentët jetojnë me familje amerikane vullnetare pritëse dhe frekuentojnë shkolla të mesme amerikane, duke shërbyer si ambasadorë kulturorë.",
          programHighlights: {
            title: "Pikat Kryesore të Programit",
            items: [
        ...
        eligibilityRequirements: {
          ...
          eligibleCountries: {
            ...
            regions: {
              ...
              europeEurasia:
                "Evropa & Eurazia: Bosnja dhe Hercegovina, Bullgaria, Turqia",
              middleEastNorthAfrica:
                "Lindja e Mesme & Afrika Veriore: Egjipti, Jordania, Maroku, Tunizia",
              southCentralAsia: "Azia Jugore & Qendrore: India, Pakistani",
              subSaharanAfrica:
                "Afrika Subsahariane: Gana, Mali, Senegali, Afrika e Jugut",
              other:
                "Dhe shumë vende të tjera me popullsi të konsiderueshme myslimane.",
            },
          },
        },
        applicationInfo: {
      ...
      "scholarship-4": {
        ...
        eligibilityRequirements: {
          ...
          eligibleCountries: {
            ...
            regions: {
              easternEurope:
                "Evropa Lindore: Republika Çeke, Estonia, Hungaria, Letonia, Lituania, Polonia, Rumania, Sllovakia",
              southeastEurope: "Evropa Juglindore: Greqia, Mali i Zi, Serbia",
              eurasia:
                "Eurazia: Armenia, Azerbajxhani, Bjellorusia, Gjeorgjia, Moldavia, Rusia, Ukraina",
              centralAsia:
                "Azia Qendrore: Kazakistani, Kirgizistani, Taxhikistani, Turkmenistani, Uzbekistani",
      ...
      "scholarship-5": {
        ...
        eligibilityRequirements: {
          ...
          eligibleCountries: {
            ...
            regions: {
              worldwide:
                "Vende nga e gjithë bota janë të pranueshme për të marrë pjesë në programin AFS Global You Adventurer.",
            },
          },
        },
        applicationInfo: {
      ...
      "scholarship-6": {
        title: "United World Colleges (UWC)",
        description:
          "Një udhëtim transformues 2-vjeçar në një nga 18 shkolla ndërkombëtare selektive në pesë kontinente. Përjeto kurrikulum prestigious të International Baccalaureate (IB) në krah të një misioni të fuqishëm: bëje arsimin një forcë për të bashkuar njerëzit, vendet dhe kulturat për paqen dhe një të ardhme të qëndrueshme. Studiohu me 3,500+ studentë nga 180+ vende në një komunitet kampusi të gjallë dhe të ndryshëm. Zhvillo aftësi lidershipi, mirëkuptim të thellë ndërkultural, ndërgjegjje mjedisore dhe zgjidhje për sfidat globale. Bashkohu me një rrjet global ish-studentësh të 50,000+ liderësh që kanë ndikim pozitiv në të gjithë botën. Kërkesate përfshijnë arritje akademike të forta (zakonisht në top 10-15% të kohorte), potencial të demonstruar lidershipi, angazhim në shërbim komunitar, rrugëpërthirje në gjuhën angleze dhe përkushtim ndaj vlerave të UWC të bashkëpunimit ndërkombëtar dhe përgjegjësisë shoqërore. Procesi i aplikimit i rreptë përfshin aplikime online përmes komiteteve kombëtare, transkripte akademike, ese personale bindëse, letra rekomandimi, intervista kombëtare dhe potenciale intervista në shkolla. Përzgjedhja thekson kuriozitetin intelektual, fuqinë e karakterit, ndërgjegjjen ndërkulturore, vizionin për kontribut në komunitetin global dhe aftësinë për të shkolluar në mjedise të ndryshme ndërkombëtare.",
        ...
        aboutProgram: {
          ...
          description:
            "UWC është një lëvizje globale e 18 shkollave ndërkombëtare selektive në vende në pesë kontinente, me mbi 3,500 studentë nga më shumë se 180 vende dhe territorje. Themeluar në 1962, UWC bën të arsyesimit të jetë një forcë për të bashkuar njerëzit, vendet dhe kultura për paqen dhe një të ardhme të qëndrueshme. Çdo UWC ofron Programin e Diplomës Ndërkombëtare (IB) të kombinuar me një filozofi edukimi të dallueshëm që thekson bashkëpunimin ndërkombëtar, qëndrueshmërinë mjedisore dhe zhvillimin e qytetarëve përgjegjës globale. Nxënësit e UWC jetojnë, studiojnë dhe punojnë së bashku në një komunitet multikulturor, duke mësuar të kuptojnë dhe të vlerësojnë perspektiva të ndryshme ndërsa zhvillojnë zgjidhje për sfidat globale.",
          programHighlights: {
            title: "Pitat Kryesore të Programit",
            items: [
              "Program Diplomë Ndërkombëtare (IB) 2-vjeçar në kampus ndërkombëtar",
              "Edukimi bazuar në katër shtylla: shkencë akademike, shprehje artistike, zhvillim atletik dhe shërbim për komunitetin",
              "Jetojnë në kampus me 3,500+ studentë nga 180+ vende dhe territorje",
              "Kurrikulum i prestigjit Ndërkombëtar (IB) i njohur në të gjithë botën",
              "Fokus në qëndrueshmërinë mjedisore, qytetarinë globale dhe lidershipin përgjegjës",
              "Akses në rrjetin global të ish-studentëve të UWC me 50,000+ profesionistë në të gjithë botën",
            ],
          },
          programComponents: {
            title: "Komponentët e Programit",
            items: [
              "Kurrikulum akademik rigoroz me Provime Ndërkombëtare (IB)",
              "Programi Creativity, Activity, Service (CAS) që integron artet, sportin dhe angazhimin komunitar",
              "Iniciativa mjedisore dhe projekte qëndrueshmërie që marrin në shqyrtim ndryshimin klimatik",
              "Edukimi për qytetarinë globale dhe punëtori dialogu ndërkulturor",
              "Zhvillim lidershipi përmes studentit vetëqeverisje dhe mentorshipi bashkëmoshatarësh",
              "Mësim përvojë me ekskursione në teren, projekte kërkimi dhe partnerime globale",
            ],
          },
        },
        eligibilityRequirements: {
          ...
          basicRequirements: {
            title: "Kërkesat Bazë",
            items: [
              "Mosha 16-19 në momentin e aplikimit (programi zgjat 2 vjet: Viti IB 1 dhe Viti 2)",
              "Qytetarë të ndonjë vendi ose rezidentë afatgjatë të ndonjë vendi UWC",
              "Arritje akademike të forta në arsimin e mëparshëm (zakonisht në top 10-15% të kohorte)",
              "Potencial i demonstruar lidershipi dhe angazhimi në aktivitete jashtëkurrikulare",
              "Rrugëpërthirje në gjuhën angleze (gjuha e mësimit në UWC)",
              "Përkushtim ndaj parimeve të UWC të bashkëpunimit ndërkombëtar dhe shërbimit",
            ],
          },
          applicationRequirements: {
            title: "Kërkesat për Aplikim",
            items: [
              "Plotëso aplikimin online përmes komitetit kombëtar të UWC",
              "Transkripte akademike të fundit dhe notat",
              "Ese personal që marrin në shqyrtim misionin e UWC dhe përshtatjen tuaj",
              "2-3 letra rekomandimi akademike dhe karakteri nga shkolla",
              "Prova e lidershipit dhe angazhimit komunitar (portofol, CV)",
              "Intervista e kryer nga komiteti i përzgjedhjes kombëtare",
              "Disa vende kërkojnë provime hyrëse",
            ],
          },
          selectionCriteria: {
            title: "Kriteret e Përzgjedhjes",
            items: [
              "Regjistrim akademik i fortë dhe kuriozitet intelektual",
              "Cilësi të demonstruara lidershipi dhe potencial për rritje",
              "Përkushtim ndaj shërbimit komunitar dhe përgjegjësisë shoqërore",
              "Ndërgjegjje ndërkulturore dhe aftësi për të ardhur mirë në mjedis të ndryshëm",
              "Vizion për kontributat e ardhshme në komunitetin global",
              "Integritet personal dhe përkushtim ndaj vlerave të UWC",
              "Aftësi komunikimi dhe frymë bashkëpunimi",
            ],
          },
        },
        applicationTimeline: {
          title: "Afatet e Aplikimit",
          timeline: {
            title: "Kalendari i Aplikimit",
            items: [
              "Regjistrim i hapur: Maj - Qershor (kontakto komitetin tuaj kombëtar të UWC)",
              "Paraqitje aplikimi: Shtator - Nëntor (ndryshon sipas vendit)",
              "Intervista kombëtare: Dhjetor - Janar",
              "Rezultate përfundimtare: Mars - Prill",
              "Studentët e pranuar konfirmojnë përputhjen: Maj",
              "Fillim i Programit: Gusht - Shtator",
            ],
          },
          requirements: {
            title: "Si të Aplikosh",
            items: [
              "Vizito uwc.org për të gjetur komitetin tuaj kombëtar të UWC",
              "Regjistrohu dhe plotëso formularin e aplikimit online",
              "Paraqit transkripte akademike, ese dhe letra rekomandimi",
              "Përgatitu për intervistë me komitetin e përzgjedhjes kombëtare",
              "Nëse zgjidhen në nivel kombëtar, intervista mund të avancoje në shkollat UWC",
              "Merr vendimin zyrtarin të pranimit dhe paketën e pranimit",
            ],
          },
          selectionProcess: {
            title: "Procesi i Përzgjedhjes",
            items: [
              "Shqyrtim i aplikimeve nga komiteti kombëtar i UWC",
              "Intervista e kryer nga anëtarët e komitetit kombëtar",
              "Vlerësim të potencialit të lidershipit dhe përshtatjes me UWC",
              "Kandidatët e shkurtuar në listë mund të intervistojnë me shkollat UWC",
              "Rekomandime përfundimtare dhe vendime të pranimit",
              "Njoftim dhe konfirmim të përputhjes nga studentët e pranuar",
            ],
          },
        },
        badgeText: {
          open: "E Hapur për Aplikime",
          upcoming: "Aplikimet do të Hapen Së Shpejti",
          closingSoon: "Mbyllet Së Shpejti",
        },
      },
    },
    ...
    lessonContent: {
      ...
      arduino: {
        ...
        2: {
          ...
          description:
            "Ndërtoni qarqen tuaj të parë! Mësoni si të lidhni një LED me Arduino dhe ta kontrolloni me kod. Këtu takohettë harduer-i me softuer-in! 💡",
          sections: [
            {
        ...
        3: {
          ...
          description:
            "Bëjeni Arduino-në tuaj interaktive! Mësoni të lexoni shtypjet e butonave dhe të përgjigjeni ndaj hyrjes së përdoruesit. Kjo hap mundësi të pafundme! 🎮",
          sections: [
            {
        ...
        5: {
          ...
          description:
            "Jepuni jetë projekteve tuaja me lëvizje! Mësoni të kontrolloni motorë DC, motorë servo dhe të krijoni robotë. 🤖",
          sections: [
            {
        ...
        6: {
          ...
          description:
            "Shfaqni informacion bukur! Mësoni të përdorni ekrane LCD për të shfaqur tekst, numra dhe për të krijuar ndërfaqe përdoruesi. 📺",
          sections: [
            {
        ...
        11: {
          ...
          description:
            "Ndieni nivelet e dritës dhe krijoni sisteme ndriçimi inteligjent! Ndërtoni drita automatike nate, gjurmues diellor dhe projekte që reagojnë ndaj dritës. ☀️",
          sections: [
            {
